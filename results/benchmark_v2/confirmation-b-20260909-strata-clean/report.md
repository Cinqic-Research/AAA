# AAA benchmark v2 — confirmation-b-20260909-strata-clean
...
|---|---|---:|---|
| straight_learning | PASS | 0.9999999999999928 | >= 0.99 relative reduction from zero control |
| straight_prediction | PASS | 2.0006050119839552e-17 | MAE <= 1e-5 and p95 <= 1e-4 in every direction/speed stratum |
...
| cpu_usability | PASS | 0.024085949999999995 | predict+update p95 <= 5 ms on the recorded CPU |
...
|---|---:|---:|---:|
| persistence | 0.00277137941223942 | 0.003847240608435147 | None |
| constant_motion | 1.86318678203563e-19 | 0.0 | None |
| zero_control | 0.00277137941223942 | 0.003847240608435147 | None |
| adaptive_rls | 2.0006050119839552e-17 | 1.1102230246251565e-16 | None |
