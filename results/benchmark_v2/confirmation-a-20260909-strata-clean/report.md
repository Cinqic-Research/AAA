# AAA benchmark v2 — confirmation-a-20260909-strata-clean
...
|---|---|---:|---|
| straight_learning | PASS | 0.9999999999999934 | >= 0.99 relative reduction from zero control |
| straight_prediction | PASS | 1.8687308644960156e-17 | MAE <= 1e-5 and p95 <= 1e-4 in every direction/speed stratum |
...
| cpu_usability | PASS | 0.022032 | predict+update p95 <= 5 ms on the recorded CPU |
...
|---|---:|---:|---:|
| persistence | 0.002839644445198009 | 0.00387641270705456 | None |
| constant_motion | 2.343283225116779e-19 | 0.0 | None |
| zero_control | 0.002839644445198009 | 0.00387641270705456 | None |
| adaptive_rls | 1.8687308644960156e-17 | 1.1102230246251565e-16 | None |
